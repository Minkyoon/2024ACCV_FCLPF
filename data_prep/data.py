...
class CL_dataset():
    def __init__(self, args):
        ...
        self.initial_classes = args.initial_classes
        self.increment_classes = args.increment_classes
        ...
        for i, label in enumerate(self.classes):
            ...
            if (i == self.initial_classes-1) or (self.args.n_tasks > 1 and i >= self.initial_classes and (i - self.initial_classes + 1) % self.increment_classes == 0):
